...
header(:class="{'active':isOpen}")
  #nav(:class="{'navOpen':isOpen}")
    ...
    ul.friendlink
      li
        a.icon.facebook(href='https://www.facebook.com/libeenya', title='Facebook' , target="_blank")
          svg(viewBox='0 0 512 512')
            path(d='M211.9 197.4h-36.7v59.9h36.7V433.1h70.5V256.5h49.2l5.2-59.1h-54.4c0 0 0-22.1 0-33.7 0-13.9 2.8-19.5 16.3-19.5 10.9 0 38.2 0 38.2 0V82.9c0 0-40.2 0-48.8 0 -52.5 0-76.1 23.1-76.1 67.3C211.9 188.8 211.9 197.4 211.9 197.4z')
      li
        a.icon.github(href='https://github.com/brain00021', title='GitHub' , target="_blank")
      ...
      li
        a.icon.linkedin(href='https://www.linkedin.com/in/bingyeli/', title='LinkedIn' , target="_blank")
          svg(viewBox='0 0 512 512')
